...
*/	
	...
	function adminUserGroupKey($str)
	{
		...
		if($c > 0)
		{
			$this->form_validation->set_message('adminUserGroupKey', 'This '.$str.' already exist in database, please try different.');
			return false;
		}
		else
			return true;
	...
	function adminUserGroupName($str)
	{
		...
		if($c > 0)
		{
			$this->form_validation->set_message('adminUserGroupName', 'This '.$str.' already exist in database, please try different.');
			return false;
		}
		else
		return true;
