...
*/	
	function mailTemplateName($str)
	{
		...
		if($c > 0)
		{
			$this->form_validation->set_message('mailTemplateName', 'This '.$str.' already exist in database, please try different.');
			return false;
		}
		else
		return true;
	...
	function mailTemplatekey($str)
	{
		...
		if($c > 0)
		{
			$this->form_validation->set_message('mailTemplatekey', 'This '.$str.' already exist in database, please try different.');
			return false;
		}
		else
		return true;
