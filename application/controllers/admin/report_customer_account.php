...
class report_customer_account extends CI_Controller {
	
	var $is_ajax = false;
	var $cAutoId = 'customer_account_manage_id';
	var $cTable = 'customer_account_manage';
	var $controller = 'report_customer_account';
	var $per_view = 1;
	
	//parent constructor will load model inside it
	function report_customer_account()
	{
		parent::__construct();
		$this->load->model('admin/report/mdl_report_customer_account','rea');
...
*/	
	...
	function index($start = 0)
	{
		...
		$data['customer_group_id'] = $this->input->get('customer_group_id');
		...
		$data['from_range_cr'] = $this->input->get('from_range_cr');
		$data['to_range_cr'] = $this->input->get('to_range_cr');
		$data['from_range_db'] = $this->input->get('from_range_db');
		$data['to_range_db'] = $this->input->get('to_range_db');
		$data['from_range_bal'] = $this->input->get('from_range_bal');
		$data['to_range_bal'] = $this->input->get('to_range_bal');
