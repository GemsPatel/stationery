...
class report_customer_cart extends CI_Controller {
	
	var $is_ajax = false;
	var $cAutoId = 'customer_id';
	var $cTable = 'customer';
	var $controller = 'report_customer_cart';
	var $per_view = 1;
	
	//parent constructor will load model inside it
	function report_customer_cart()
	{
		parent::__construct();
		$this->load->model('admin/report/mdl_report_customer_cart','rea');
