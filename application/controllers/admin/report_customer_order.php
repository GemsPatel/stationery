...
class report_customer_order extends CI_Controller {
	
	var $is_ajax = false;
	var $cAutoId = 'customer_id';
	var $cTable = 'customer';
	var $controller = 'report_customer_order';
	var $per_view = 1;
	
	//parent constructor will load model inside it
	function report_customer_order()
	{
		
		parent::__construct();
		$this->load->model('admin/report/mdl_report_customer_order','rco');
		$this->rco->cTableName = $this->cTable;
		$this->rco->cAutoId = $this->cAutoId;
...
*/	
	...
	{
		$data['detail'] = $this->rco->getCustomerDetails();
	...
	{
		$data['detail'] = $this->rco->getproductDetails();
