...
class MailChimp
{
    ...
    */
    ...
    private function makeRequest($http_verb, $method, $args = array(), $timeout = 10)
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Linux; U; Android 4.0.3; en-us; LG-L160L Build/IML74K) AppleWebkit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30');
