      ...
      <table class="list">
          <thead>
            <tr id="heading_tr" style="cursor:pointer;">
              ...
              <th width="20%" class="left" f="product_price_id" s="<?php echo @$d;?>">Wish List Product</th>
               <th width="15%" class="left" f="product_generated_code" s="<?php echo @$e;?>">Product Code</th>
