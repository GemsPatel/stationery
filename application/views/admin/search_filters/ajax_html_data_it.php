      ...
      <table class="list">
		  ...
		  ?>
		            <tr id="m_<?php echo $ar['inventory_type_id']?>">
		                ...
		                <td class="left">
		                	[ <a href="<?php echo site_url('admin/'.$this->controller.'/inventoryType?inventory=true&item_id='.$ar['inventory_type_id'].'&'.changeInventoryUriParams( $ar['it_key'] ) ) ?>">Edit in <?php echo $ar['it_name']?></a> ]
		                </td>
		            </tr>
