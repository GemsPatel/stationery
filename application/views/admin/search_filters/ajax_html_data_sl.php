      ...
      <table class="list">
		  ...
		  ?>
		            <tr id="m_<?php echo $ar['manufacturer_id']?>">
		                ...
		                <td class="left">[ <a href="<?php echo site_url('admin/'.$this->controller.'/itemLanguages?edit=true&item_id='._en($ar['item_id']).'&'.changeLangUriParams($ar['manufacturer_id'], $ar['manufacturer_key']))?>">Edit in <?php echo $ar['manufacturer_name'] ?></a> ] </td>
		            </tr>
