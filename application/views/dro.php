						...
						<p>
							<?php 
								...
								if( MANUFACTURER_ID == 7 ):
									...
									$artRow = fetchRow( "SELECT article_name,article_description, article_image FROM article WHERE article_key='DRO'  " );
									
								else: 
								
									$artRow = fetchRow( "SELECT article_name,article_description, article_image FROM article_cctld WHERE article_key='DRO' AND manufacturer_id = '$mfg'" );
